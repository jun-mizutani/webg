...
- `async copyDiagnosticsSummary(options = {})`: diagnostics summary を clipboard へ送る
- `async copyDiagnosticsReportJSON(options = {})`: diagnostics report JSON を clipboard へ送る
