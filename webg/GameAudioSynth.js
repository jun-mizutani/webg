...
export default class GameAudioSynth extends AudioSynth {
  ...
  installMelodyPresets() {
    ...
    // 追加メロディプリセット（basePresetsへ統合）
    basePresets.push(
      { name: "sunrise_step", 
        scale: [0, 2, 4, 5, 7, 9, 11], 
        bassPattern: [0, -5, -3, -2], 
        leadGate: [0, 2, 4, 7, 8, 10, 12, 14], 
        leadDegreeStep: 2, 
        leadType: "triangle", 
        leadDur: 0.11, 
        leadGain: 0.060, 
      ...
      { name: "comet_lane", 
        scale: [0, 2, 3, 5, 7, 8, 10], 
        bassPattern: [0, -7, -5, -2], 
        leadDegrees: [0, 2, 3, 5, 7, 5, 3, 2, 0, 2, 3, 7, 8, 10, 8, 7], 
        leadType: "square", 
        leadDur: 0.10, 
        leadGain: 0.064, 
        bassType: "triangle", 
      ...
      { name: "crystal_arc", 
        scale: [0, 2, 4, 7, 9, 12], 
        bassPattern: [0, -3, -5, null], 
        leadDegrees: [0, 2, 4, null, 5, 4, 2, null, 0, 4, 6, null, 8, 6, 4, null], 
        leadType: "sine", 
        leadDur: 0.16, 
        leadGain: 0.052, 
        bassType: "sawtooth", 
      ...
      { name: "neon_waltz", 
        scale: [0, 2, 4, 5, 7, 9, 11], 
        bassPattern: [0, -3, -5, -7], 
        leadDegrees: [0, 2, 4, 5, 7, 5, 4, 2, 0, 2, 4, 7, 9, 7, 5, 4], 
        leadType: "triangle", 
        leadDur: 0.12, 
        leadGain: 0.060, 
        bassType: "triangle", 
      ...
      { name: "orbit_runner", 
        scale: [0, 2, 3, 5, 7, 8, 10], 
        bassPattern: [0, -5, -2, -7], 
        leadDegrees: [0, 2, 3, 5, 7, 8, 7, 5, 3, 2, 0, 2, 3, 5, 7, 10], 
        leadHoldSteps: [1, 1, 1, 1.8, 1, 1, 1, 2.1, 1, 1, 1, 1.6, 1, 1, 1, 2.6], 
        leadType: "square", 
        leadDur: 0.11, 
        leadGain: 0.064, 
        bassType: "triangle", 
      ...
      { name: "lunar_bounce", 
        scale: [0, 2, 4, 7, 9, 12], 
        bassPattern: [0, -3, -5, -2], 
        leadDegrees: [0, 2, 4, 2, 5, 4, 2, 0, 4, 6, 8, 6, 9, 8, 6, 4], 
        leadType: "triangle", 
        leadDur: 0.11, 
        leadGain: 0.063, 
        bassType: "triangle", 
      ...
      { name: "drift_echo", 
        scale: [0, 2, 3, 5, 7, 8, 10], 
        bassPattern: [0, -5, null, -7], 
        leadDegrees: [0, 2, 3, 5, 7, 5, 3, 2, 0, null, 2, 3, 7, 8, 10, 8], 
        leadHoldSteps: [1, 1, 1, 1.8, 1, 1, 1, 2.1, 1, 1, 1, 1.7, 1, 1, 1, 2.7], 
        leadType: "triangle", 
        leadDur: 0.13, 
        leadGain: 0.057, 
        bassType: "triangle", 
      ...
      { name: "arcade_flash", 
        scale: [0, 2, 4, 5, 7, 9, 11], 
        bassPattern: [0, -5, -3, -7], 
        leadGate: [0, 2, 3, 4, 6, 8, 10, 11, 12, 14], 
        leadDegreeStep: 4, 
        leadType: "square", 
        leadDur: 0.09, 
        leadGain: 0.067, 
      ...
      { name: "harbor_light", 
        scale: [0, 2, 4, 7, 9, 12], 
        bassPattern: [0, -3, -5, -2], 
        leadDegrees: [0, 2, 4, 7, 9, 7, 4, 2, 0, 2, 4, 7, 9, 7, 4, 2], 
        leadType: "triangle", 
        leadDur: 0.12, 
        leadGain: 0.058, 
        bassType: "triangle", 
      ...
      { name: "desert_loop", 
        scale: [0, 1, 3, 5, 6, 8, 10], 
        bassPattern: [0, -1, -5, -6], 
        leadDegrees: [0, 3, 6, 3, 1, 3, 6, 8, 6, 3, 1, 0, 10, 8, 6, 3], 
        leadType: "sawtooth", 
        leadDur: 0.11, 
        leadGain: 0.067, 
        bassType: "square", 
      ...
      { name: "starlit_hook", 
        scale: [0, 2, 3, 5, 7, 8, 10], 
        bassPattern: [0, -5, -2, -7], 
        leadDegrees: [0, 2, 3, 5, 7, 5, 3, 2, 7, 8, 10, 8, 7, 5, 3, 2], 
        leadHoldSteps: [1, 1, 1, 1.7, 1, 1, 1, 2.0, 1, 1, 1, 1.9, 1, 1, 1, 2.5], 
        leadType: "triangle", 
        leadDur: 0.12, 
        leadGain: 0.060, 
        bassType: "triangle", 
      ...
      { name: "twilight_swing",
        ...
        bassPattern: [0, -5, -3, -2], 
        leadDegrees: [0, 2, 4, 5, 7, 5, 4, 2, 0, 2, 4, 7, 9, 7, 5, 4], 
        leadHoldSteps: [1, 1, 1, 1.6, 1, 1, 1, 2.0, 1, 1, 1, 1.6, 1, 1, 1, 2.4], 
        leadType: "triangle", 
        leadDur: 0.12, 
        leadGain: 0.058, 
        bassType: "triangle",
