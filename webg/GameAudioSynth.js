...
export default class GameAudioSynth extends AudioSynth {
  ...
  installSePresets() {
    ...
    this.gameSe = {
      paddle: (t0) => {
        tone(t0, 520, 0.12, "percussion", { type: "triangle", gain: 0.10, release: 0.10, pan: -0.10 });
        tone(t0 + 0.018, 780, 0.14, "guitar", { type: "square", gain: 0.06, release: 0.10, pan: 0.12 });
        tone(t0 + 0.050, 1040, 0.18, "woodwind", { type: "sine", gain: 0.05, release: 0.16, pan: 0.26 });
        tone(t0 + 0.006, 330, 0.20, "piano", { type: "triangle", gain: 0.05, release: 0.20, pan: -0.28 });
      },
      wall: (t0) => {
        tone(t0, 260, 0.10, "percussion", { type: "sine", gain: 0.09, release: 0.08, pan: -0.04 });
        tone(t0 + 0.018, 520, 0.12, "woodwind", { type: "triangle", gain: 0.05, release: 0.10, pan: 0.08 });
        tone(t0 + 0.052, 980, 0.16, "guitar", { type: "sine", gain: 0.04, release: 0.14, pan: 0.18 });
      },
      block: (t0) => {
        tone(t0, 620, 0.11, "percussion", { type: "triangle", gain: 0.08, release: 0.09, pan: -0.08 });
        tone(t0 + 0.016, 930, 0.12, "guitar", { type: "square", gain: 0.055, release: 0.10, pan: 0.08 });
        tone(t0 + 0.040, 1480, 0.18, "woodwind", { type: "sine", gain: 0.04, release: 0.16, pan: 0.22 });
        tone(t0 + 0.006, 260, 0.16, "piano", { type: "triangle", gain: 0.05, release: 0.18, pan: -0.22 });
      },
      levelup: (t0) => {
        tone(t0, 392, 0.14, "piano", { type: "triangle", gain: 0.09, release: 0.12, pan: -0.10 });
        tone(t0 + 0.10, 523.25, 0.16, "piano", { type: "triangle", gain: 0.10, release: 0.14, pan: 0.02 });
        tone(t0 + 0.22, 659.25, 0.18, "piano", { type: "triangle", gain: 0.10, release: 0.16, pan: 0.14 });
        tone(t0 + 0.34, 783.99, 0.22, "organ", { type: "sine", gain: 0.08, release: 0.18, pan: 0.24 });
      },
      gameover: (t0) => {
        tone(t0, 329.63, 0.20, "percussion", { type: "sawtooth", gain: 0.11, release: 0.14, pan: -0.06 });
        tone(t0 + 0.12, 246.94, 0.24, "percussion", { type: "sawtooth", gain: 0.10, release: 0.16, pan: 0.00 });
        tone(t0 + 0.28, 196.00, 0.30, "percussion", { type: "triangle", gain: 0.09, release: 0.20, pan: -0.10 });
        tone(t0 + 0.42, 146.83, 0.32, "organ", { type: "sine", gain: 0.06, release: 0.24, pan: 0.12 });
      },
      // ぽよーん
      poyoon: (t0) => {
        tone(t0, 280, 0.16, "piano", { type: "triangle", gain: 0.11, release: 0.14, pan: -0.16 });
        tone(t0 + 0.045, 430, 0.18, "woodwind", { type: "sine", gain: 0.08, release: 0.16, pan: 0.06 });
        tone(t0 + 0.120, 650, 0.24, "organ", { type: "triangle", gain: 0.05, release: 0.18, pan: 0.22 });
      },
      // ぴよーん
      piyoon: (t0) => {
        tone(t0, 560, 0.10, "guitar", { type: "square", gain: 0.10, release: 0.08, pan: -0.10 });
        tone(t0 + 0.028, 880, 0.12, "piano", { type: "triangle", gain: 0.08, release: 0.10, pan: 0.08 });
        tone(t0 + 0.070, 1320, 0.16, "woodwind", { type: "sine", gain: 0.05, release: 0.14, pan: 0.20 });
      },
      // バーン
      baan: (t0) => {
        tone(t0, 110, 0.16, "percussion", { type: "sawtooth", gain: 0.13, release: 0.12, pan: -0.05 });
        tone(t0 + 0.012, 72, 0.22, "percussion", { type: "triangle", gain: 0.11, release: 0.18, pan: 0.04 });
        tone(t0 + 0.045, 240, 0.08, "percussion", { type: "square", gain: 0.05, release: 0.07, pan: 0.12 });
      },
      // シュパ
      shupa: (t0) => {
        tone(t0, 980, 0.08, "brass", { type: "sawtooth", gain: 0.08, release: 0.07, pan: -0.38 });
        tone(t0 + 0.020, 680, 0.10, "brass", { type: "sawtooth", gain: 0.07, release: 0.08, pan: 0.30 });
        tone(t0 + 0.050, 420, 0.14, "piano", { type: "triangle", gain: 0.05, release: 0.12, pan: 0.04 });
      },
      coin: (t0) => {
        tone(t0, 880, 0.08, "guitar", { type: "square", gain: 0.08, release: 0.07, pan: -0.10 });
        tone(t0 + 0.028, 1320, 0.10, "guitar", { type: "square", gain: 0.08, release: 0.08, pan: 0.04 });
        tone(t0 + 0.056, 1760, 0.12, "piano", { type: "triangle", gain: 0.05, release: 0.10, pan: 0.18 });
      },
      jump: (t0) => {
        tone(t0, 300, 0.08, "percussion", { type: "triangle", gain: 0.09, release: 0.07, pan: -0.08 });
        tone(t0 + 0.030, 494, 0.12, "piano", { type: "triangle", gain: 0.08, release: 0.10, pan: 0.03 });
        tone(t0 + 0.090, 660, 0.16, "organ", { type: "sine", gain: 0.06, release: 0.14, pan: 0.14 });
      },
      laser: (t0) => {
        tone(t0, 1480, 0.05, "brass", { type: "square", gain: 0.08, release: 0.05, pan: -0.28 });
        tone(t0 + 0.016, 1120, 0.06, "brass", { type: "square", gain: 0.07, release: 0.05, pan: -0.05 });
        tone(t0 + 0.032, 840, 0.08, "brass", { type: "square", gain: 0.06, release: 0.06, pan: 0.12 });
        tone(t0 + 0.056, 560, 0.11, "piano", { type: "triangle", gain: 0.05, release: 0.09, pan: 0.22 });
      },
      damage: (t0) => {
        tone(t0, 220, 0.10, "percussion", { type: "sawtooth", gain: 0.10, release: 0.10, pan: -0.06 });
        tone(t0 + 0.040, 160, 0.14, "percussion", { type: "sawtooth", gain: 0.09, release: 0.12, pan: 0.02 });
        tone(t0 + 0.090, 110, 0.18, "organ", { type: "triangle", gain: 0.07, release: 0.16, pan: 0.12 });
      },
      powerup: (t0) => {
        tone(t0, 392, 0.10, "piano", { type: "triangle", gain: 0.07, release: 0.10, pan: -0.12 });
        tone(t0 + 0.050, 523.25, 0.12, "piano", { type: "triangle", gain: 0.08, release: 0.11, pan: -0.02 });
        tone(t0 + 0.110, 659.25, 0.14, "piano", { type: "triangle", gain: 0.09, release: 0.12, pan: 0.10 });
        tone(t0 + 0.170, 783.99, 0.18, "piano", { type: "triangle", gain: 0.09, release: 0.14, pan: 0.20 });
        tone(t0 + 0.240, 987.77, 0.22, "organ", { type: "sine", gain: 0.06, release: 0.18, pan: 0.28 });
      },
      ui_move: (t0) => {
        tone(t0, 740, 0.05, "guitar", { type: "square", gain: 0.04, release: 0.05, pan: -0.06 });
        tone(t0 + 0.018, 880, 0.06, "piano", { type: "triangle", gain: 0.03, release: 0.05, pan: 0.05 });
      },
      ui_ok: (t0) => {
        tone(t0, 660, 0.06, "guitar", { type: "triangle", gain: 0.06, release: 0.06, pan: -0.04 });
        tone(t0 + 0.032, 990, 0.08, "guitar", { type: "triangle", gain: 0.06, release: 0.06, pan: 0.06 });
        tone(t0 + 0.076, 1320, 0.10, "woodwind", { type: "sine", gain: 0.04, release: 0.08, pan: 0.18 });
      },
      countdown: (t0) => {
        tone(t0, 520, 0.05, "percussion", { type: "square", gain: 0.06, release: 0.05, pan: -0.04 });
        tone(t0 + 0.110, 520, 0.05, "percussion", { type: "square", gain: 0.06, release: 0.05, pan: 0.02 });
        tone(t0 + 0.240, 760, 0.08, "guitar", { type: "square", gain: 0.07, release: 0.06, pan: 0.10 });
        tone(t0 + 0.360, 1046, 0.10, "piano", { type: "triangle", gain: 0.05, release: 0.08, pan: 0.22 });
      },
      // reverb と envelope の差を聞き分けやすくする確認用SE
      // 冒頭の短い輪郭音で attack を、その後の長めの胴鳴りで decay / sustain / release と reverb tail を追いやすくする
      tail_probe: (t0) => {
        tone(t0, 523.25, 0.08, "piano", { type: "triangle", gain: 0.08, release: 0.06, pan: -0.22 });
        tone(t0 + 0.050, 659.25, 0.12, "woodwind", { type: "sine", gain: 0.06, release: 0.09, pan: 0.18 });
        tone(t0 + 0.120, 392.00, 0.48, "organ", { type: "triangle", gain: 0.11, release: 0.22, pan: -0.10 });
        tone(t0 + 0.200, 587.33, 0.56, "organ", { type: "sine", gain: 0.10, release: 0.28, pan: 0.12 });
        tone(t0 + 0.380, 783.99, 0.36, "piano", { type: "triangle", gain: 0.06, release: 0.20, pan: 0.26 });
        tone(t0 + 0.520, 1046.50, 0.24, "guitar", { type: "square", gain: 0.04, release: 0.16, pan: 0.34 });
      }
    };

    // sound sample などで「どの SE がどの envelope profile を使うか」を追えるようにする
    this.soundEffectCatalog = {
      paddle: { label: "paddle", profiles: ["percussion", "guitar", "woodwind", "piano"], primaryProfile: "percussion" },
      wall: { label: "wall", profiles: ["percussion", "woodwind", "guitar"], primaryProfile: "percussion" },
      block: { label: "block", profiles: ["percussion", "guitar", "woodwind", "piano"], primaryProfile: "percussion" },
      levelup: { label: "levelup", profiles: ["piano", "organ"], primaryProfile: "piano" },
      gameover: { label: "gameover", profiles: ["percussion", "organ"], primaryProfile: "percussion" },
      poyoon: { label: "poyoon", profiles: ["piano", "woodwind", "organ"], primaryProfile: "piano" },
      piyoon: { label: "piyoon", profiles: ["guitar", "piano", "woodwind"], primaryProfile: "guitar" },
      baan: { label: "baan", profiles: ["percussion"], primaryProfile: "percussion" },
      shupa: { label: "shupa", profiles: ["brass", "guitar"], primaryProfile: "brass" },
      coin: { label: "coin", profiles: ["guitar", "piano"], primaryProfile: "guitar" },
      jump: { label: "jump", profiles: ["percussion", "piano", "organ"], primaryProfile: "percussion" },
      laser: { label: "laser", profiles: ["brass", "guitar"], primaryProfile: "brass" },
      damage: { label: "damage", profiles: ["percussion", "organ"], primaryProfile: "percussion" },
      powerup: { label: "powerup", profiles: ["piano", "organ"], primaryProfile: "piano" },
      ui_move: { label: "ui_move", profiles: ["guitar", "percussion"], primaryProfile: "guitar" },
      ui_ok: { label: "ui_ok", profiles: ["guitar", "woodwind"], primaryProfile: "guitar" },
      countdown: { label: "countdown", profiles: ["percussion", "guitar", "piano"], primaryProfile: "percussion" },
      tail_probe: { label: "tail_probe", profiles: ["piano", "woodwind", "organ", "percussion", "guitar"], primaryProfile: "organ" }
    };
  }
