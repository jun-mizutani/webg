// ---------------------------------------------
// headless_tests/core/animation_state/api_contracts.js  2026/07/17
...
const summary = failCount === 0
  ? `PASS animation_state_api_contracts (${passCount} checks)`
  : `FAIL animation_state_api_contracts (${failCount} failed / ${passCount} passed)`;
if (failCount === 0) {
  console.log(summary);
} else {
