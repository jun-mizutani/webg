...
function createPhongShape(gpu, buildShape, material) {
...
function buildScene() {
  ...
  const floorShape = createPhongShape(gpu, (shape) => {
  ...
  const towerShape = createPhongShape(gpu, (shape) => {
  ...
  const markerShape = createPhongShape(gpu, (shape) => {
  ...
  const bodyShape = createPhongShape(gpu, (shape) => {
  ...
  const headShape = createPhongShape(gpu, (shape) => {
  ...
  const noseShape = createPhongShape(gpu, (shape) => {
  ...
  const centerShape = createPhongShape(gpu, (shape) => {
