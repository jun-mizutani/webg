// ---------------------------------------------
// unittest/physics_node_contracts/main.js  2026/05/06
...
const finish = (app) => {
  const summary = failCount === 0
    ? `PASS physics_node_contracts (${passCount} checks)`
    : `FAIL physics_node_contracts (${failCount} failed / ${passCount} passed)`;
  app.setStatus(`${summary}\n\n${lines.join("\n")}`);
};

bootUnitTestApp({
  clearColor: [0.04, 0.06, 0.08, 1.0],
  initialStatus: "running physics_node_contracts..."
}, (app) => {
